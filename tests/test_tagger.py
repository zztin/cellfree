...
class TestMultiomeTaggingCHIC(unittest.TestCase):
    def test_write_to_read_grouped_sorted(self):
        ...
        tm.run_multiome_tagging_cmd(
            f"./data/chic_test_region.bam -method chic -o {write_path}".split(" ")
        )
        ...
        with pysam.AlignmentFile(write_path) as f:
            self.assertTrue(
                1
                == len(
                    [x for x in f.header["PG"] if "bamtagmultiome" in x.get("PN", "")]
                )
            )
    ...
    def test_write_to_read_grouped_multi(self):
        write_path = "./data/write_test_chic_rg.bam"
        tm.run_multiome_tagging_cmd(
            f"./data/chic_test_region.bam -contig 8 -method chic --multiprocess -o {write_path}".split(
                " "
            )
        )
...
class TestMultiomeTaggingNLA(unittest.TestCase):
    def test_write_to_read_grouped_sorted(self):
        ...
        tm.run_multiome_tagging_cmd(
            f"./data/mini_nla_test.bam --allow_cycle_shift -method nla -o {write_path}".split(
                " "
            )
        )
    ...
    def test_tag_no_cycle_shift(self):
        write_path = "./data/write_test_rg.bam"
        tm.run_multiome_tagging_cmd(
            f"./data/mini_nla_test.bam -method nla -o {write_path}".split(" ")
        )
    ...
    def test_write_to_read_grouped_sorted_no_rejects(self):
        write_path = "./data/write_test_rg.bam"
        tm.run_multiome_tagging_cmd(
            f"./data/mini_nla_test.bam --no_rejects --allow_cycle_shift -method nla -o {write_path}".split(
                " "
            )
        )
    ...
    def test_skip_contig(self):
        write_path = "./data/write_test_rg.bam"
        tm.run_multiome_tagging_cmd(
            f"./data/mini_nla_test.bam --no_rejects --allow_cycle_shift -method nla -skip_contig chr1,chrMT -o {write_path}".split(
                " "
            )
        )
    ...
    def test_skip_contig_invert(self):
        write_path = "./data/write_test_rg.bam"
        tm.run_multiome_tagging_cmd(
            f"./data/mini_nla_test.bam --no_rejects --allow_cycle_shift -method nla -skip_contig chr2,chr3 -o {write_path}".split(
                " "
            )
        )
    ...
    def test_skip_contig_multi_process(self):
        write_path = "./data/write_test_rg.bam"
        tm.run_multiome_tagging_cmd(
            f"./data/mini_nla_test.bam --multiprocess --no_rejects --allow_cycle_shift -method nla -skip_contig chr1,chrMT -o {write_path}".split(
                " "
            )
        )
    ...
    def test_skip_contig_invert_multi_process(self):
        write_path = "./data/write_test_rg.bam"
        tm.run_multiome_tagging_cmd(
            f"./data/mini_nla_test.bam --multiprocess --no_rejects --allow_cycle_shift -method nla -skip_contig chr2,chr3 -o {write_path}".split(
                " "
            )
        )
